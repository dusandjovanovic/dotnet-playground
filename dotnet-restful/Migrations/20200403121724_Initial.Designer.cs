...
namespace dotnet_restful.Migrations
{
    ...
    [Migration("20200403121724_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnet_restful.Data.Entities.Camp", b =>
                {
            ...
            modelBuilder.Entity("dotnet_restful.Data.Entities.Location", b =>
                {
                    b.Property<int>("LocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("dotnet_restful.Data.Entities.Speaker", b =>
                {
            ...
            modelBuilder.Entity("dotnet_restful.Data.Entities.Talk", b =>
                {
            ...
            modelBuilder.Entity("dotnet_restful.Data.Entities.Camp", b =>
                {
                    b.HasOne("dotnet_restful.Data.Entities.Location", "Location")
                        .WithMany()
            ...
            modelBuilder.Entity("dotnet_restful.Data.Entities.Talk", b =>
                {
                    b.HasOne("dotnet_restful.Data.Entities.Camp", "Camp")
                        .WithMany("Talks")
                        .HasForeignKey("CampId");

                    b.HasOne("dotnet_restful.Data.Entities.Speaker", "Speaker")
                        .WithMany()
