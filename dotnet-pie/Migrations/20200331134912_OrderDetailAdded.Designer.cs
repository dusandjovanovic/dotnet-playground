...
namespace dotnet_pie.Migrations
{
    ...
    [Migration("20200331134912_OrderDetailAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnet_pie.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("dotnet_pie.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("dotnet_pie.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("dotnet_pie.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("dotnet_pie.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("dotnet_pie.Models.OrderDetail", b =>
                {
                    b.HasOne("dotnet_pie.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("dotnet_pie.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("dotnet_pie.Models.Pie", b =>
                {
                    b.HasOne("dotnet_pie.Models.Category", "Category")
                        .WithMany("Pies")
